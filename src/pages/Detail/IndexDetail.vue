    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <IndexZoom :skuImageList="skuImageList" />
          <!-- 小图列表 -->
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="mins" @click="skuNum>1?skuNum--:skuNmu=1">-</a>
              </div>
              <div class="add">
...
<script>
  ...
  import IndexZoom from './Zoom/IndexZoom.vue'
  ...
  export default {
    ...
    methods: {
      ...
      // 加入购物车，不仅需要路由调转，还需要发请求
      async addShopcar(){
        // 发请求，并且需要知道请求是成功还是失败
        try {
          let reusult = await this.$store.dispatch('addOrUpdateShopCart',{skuId:this.$route.params.skuid,skuNum:this.skuNum})
          // 进行路由跳转,还要将产品信息带给下一级路由组件
          // 复杂参数用会话存储，否则顶上链接复杂且不好看
